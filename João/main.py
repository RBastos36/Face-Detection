...
def main():
    ...
    while(cap.isOpened()): # iterate video frames
        ...
        if len(database_photos) > len_old_database:
            ...
            cv2.moveWindow('Database', 0, int(height))
            ...
            for i in range(len(images)):
                ...
                cv2.putText(images[i], str(known_face_names[i]), (5,15), cv2.FONT_HERSHEY_DUPLEX, 0.5, (255, 255, 255), 1, cv2.LINE_AA)
